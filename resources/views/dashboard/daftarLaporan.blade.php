...
@section('container')
      ...
      @if(session()->has('notifproses'))
      <div class="notif-login alert-success" data-aos="fade-down">
        <div class="text-center">
          <strong>{{ session('notifproses') }}</strong>
        </div>
      </div>
      @endif
      @if(session()->has('notifselesai'))
      <div class="notif-login alert-success" data-aos="fade-down">
        <div class="text-center">
          <strong>{{ session('notifselesai') }}</strong>
        </div>
      </div>
      @endif
      @if(session()->has('gagalverif'))
      <div class="notif-login alert-success" data-aos="fade-down">
        <div class="text-center">
          <strong>{{ session('gagalverif') }}</strong>
        </div>
      </div>
      @endif
    ...
    <div class="dropdown my-2 filter-button" style="margin-left: 3px;">
      ...
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="padding: 0px;">
        <li style="border-bottom: 1px solid grey"><a class="dropdown-item @if(Request::is("dashboardLaporan")) bg-dark text-white @endif" href="/dashboardLaporan" style="border-top-left-radius: .25rem;border-top-right-radius: .25rem;"><i class="bi bi-clipboard2"></i> Semua Laporan</a></li>
        ...
        <li><a class="dropdown-item @if(Request::is("dashboardLaporan/selesai")) bg-dark @endif" href="/dashboardLaporan/{{ 'selesai' }}" style="color: green;border-radius: 0px;"><i class="bi bi-check2"></i> Selesai</a></li>
      </ul>
    </div>
    </div>
                ...
                <td class="align-middle"> 
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" style="color: red;"  href="/deletelaporan/{{ $item->id_pengaduan }}" ><i class="bi bi-x-lg"></i> Gagal Verifikasi</a></li>
                    </ul>
                  </div>
              ...
              <tr>
                ...
                <td class="align-middle">
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" style="color: green;" href="/konfirmasilaporan/{{ $item->id_pengaduan }}"><i class="bi bi-check2"></i> Selesai</a></li>
                    </ul>
                  </div>
                </td>
              </tr>
